...
export function SantoReader() {
  ...
  // Inizializza data da parametri URL se presente
  useEffect(() => {
  ...
  // Fetch dati del Santo per il Rito Romano (Martirologio CEI)
  ...
  // Apri Generatore Card WhatsApp con supporto per l'iconografia sacra
